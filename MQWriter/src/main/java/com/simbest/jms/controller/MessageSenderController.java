...
public class MessageSenderController {
    ...
    @Autowired
    @Qualifier("jmsTemplateTopicSecond")
    private JmsTemplate getJmsTemplateTopicSecond;
    ...
    public String sendSampleTopic() {
        try {
            ...
            getJmsTemplateTopicSecond.send((session) -> session.createTextMessage("Send Sample Topic Message Second!"));
